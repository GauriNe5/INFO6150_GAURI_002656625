...
import cosafe1 from "../../images/fizz1.png";
import cosafe2 from "../../images/todolist.png";
import cosafe3 from "../../images/weather.png";

const Slider = () => {
  const slides = [
    { 
      title: "Weather Api", 
      subTitle: "Project 10 Api", 
      text: "Api to extract data using JavaScript and React Js",
      bigPicture: cosafe3,
      link: "https://github.com/GauriNe5/INFO6150_GAURI_002656625/tree/main/Project10_Weather_API_Updated",
      isWeb: true
    },
    {
    ...
    link: "https://github.com/GauriNe5/INFO6150_GAURI_002656625/tree/main/Project%207_Number_guessing",
    isWeb: true
  },
  { 
    title: "Book Store", 
    ...
    link: "https://github.com/GauriNe5/INFO6150_GAURI_002656625/tree/main/books%20webstie",
    isWeb: true
  },
  { 
    title: "Fizz Buzz", 
